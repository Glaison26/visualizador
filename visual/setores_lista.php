...
<body>
    <script language="Javascript">
        function confirmacao(id) {
            ...
            if (resposta == true) {
                window.location.href = "/visualizador/modelagem/setores_excluir.php?id=" + id;
            }
        }
    </script>
    ...
    <script type="text/javascript">
        $(document).on('submit', '#frmadd', function(e) {
            ...
            if (c_descricao != '') {
                ...
                $.ajax({
                    url: "/visualizador/modelagem/setores_novo.php",
                    type: "post",
                    data: {
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#frmup', function(e) {
            ...
            if (c_descricao != '') {
                ...
                $.ajax({
                    url: "/visualizador/modelagem/setores_editar.php",
                    type: "post",
                    data: {
                        c_id: c_id,
                        c_descricao: c_descricao
    ...
    <div class="container-fluid">
        <br>
        <button type="button" title="Inclusão de Novo Setor" class="btn btn-success btn-sm" data-toggle="modal" data-target="#novoModal"><span class="glyphicon glyphicon-plus"></span>
            Incluir
        </button>
        <a class="btn btn-secondary btn-sm" href="/visualizador/menu.php"><span class="glyphicon glyphicon-off"></span> Voltar</a>
        ...
        <table class="table table-bordered table-striped tabsetores">
            ...
            <tbody>
                ...
                $c_sql = "SELECT setores.id, setores.descricao FROM setores ORDER BY setores.descricao";
                ...
                while ($c_linha = $result->fetch_assoc()) {
                    ...
                    <td>
                    <button type='button' class='btn btn-secondary btn-sm editbtn' data-toggle='modal' title='Editar Setores'><span class='glyphicon glyphicon-pencil'></span> Editar</button>
        ...
        <div class="modal-dialog modal-dialog-centered" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Inclusão de novo Setor</h4>
                </div>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="editmodal" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Editar Setor</h4>
                </div>
                <div class="modal-body">
                    <div class='alert alert-warning' role='alert'>
                        <h5>Campos com (*) são obrigatórios</h5>
